...
const plans = [
    {
        ...
        features: [
            "1 squad, unlimited members",
            "Match scheduling & availability heatmap",
            "Live scoring with full tennis rules",
            "Ladder rankings, challenges & box league",
            "1 team league at a time",
            "Serve Coach (on-device)",
            "Squad chat & “need a sub”",
    ...
    },
    {
        ...
        description: "For players who run the squad and want the full picture.",
        features: [
            "Everything in Free, plus:",
            "Live score on your Lock Screen & Dynamic Island",
            "Next Match home screen widget",
            "Matches logged to Apple Health",
            "Tennis Wrapped — your season recap",
            "Complete match history",
            "Unlimited squads & concurrent leagues",
                            ...
                            <FadeIn key={plan.name} delay={i * 0.1}>
                                ...
                                >
                                    ...
                                    <div className="mb-6">
                                        ...
                                        {plan.altPrice && (
                                            <p className="text-sm text-primary mt-2">{plan.altPrice}</p>
                                        )}
                                    </div>
